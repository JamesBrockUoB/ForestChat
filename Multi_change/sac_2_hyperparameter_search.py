...
SWEEP_CONFIG = {
    "name": "AnyChange2 Hyperparameter Search",
    "method": "bayes",
...
class AnyChange2HyperparameterSearcher(object):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="./models_ckpt/sam2.1_hiera_large.pt",
    ...
    parser.add_argument(
        ...
        help="path of the sam2 config model being used",
    )
    ...
    searcher = AnyChange2HyperparameterSearcher(args)
