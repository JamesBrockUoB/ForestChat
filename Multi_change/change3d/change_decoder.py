...
class ChangeDecoder(nn.Module):
    ...
    def __init__(
        self, args, in_dim: List[int] = [64, 128, 256, 384], has_sigmoid: bool = False
    ) -> None:
        """
        ...
        self.up_c2 = nn.Sequential(
            ...
            nn.ConvTranspose2d(
                c1_channel, c1_channel, kernel_size=4, stride=2, padding=1
            ),
        )
        ...
        self.up_c1 = nn.Sequential(
            nn.Conv2d(
                c1_channel, num_class, kernel_size=3, stride=1, padding=1, bias=False
            )
        )
