...
if __name__ == "__main__":
    ...
    imgA_path = "./data/LEVIR-MCI-dataset/images/test/A/test_000004_A.png"
    imgB_path = "./data/LEVIR-MCI-dataset/images/test/B/test_000004_B.png"
    ...
    percentage = Change_Perception.compute_deforestation_percentage(savepath_mask)
    print(num)
    print(percentage)
